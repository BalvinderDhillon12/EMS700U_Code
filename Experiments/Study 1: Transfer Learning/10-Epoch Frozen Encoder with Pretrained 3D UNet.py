...
output_dir = f"/content/drive/MyDrive/4thyearproject_code/RESULTS/10_EPOCHS_FROZEN_{timestamp}"
...
torch.save(model.state_dict(), os.path.join(output_dir, f"model2_study1_pretrained_final.pth"))
